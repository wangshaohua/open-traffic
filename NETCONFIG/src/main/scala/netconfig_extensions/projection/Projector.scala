 ...
 * [[netconfig_extensions.projection.KDProjector]]
 * and [[netconfig_extensions.projection.NaiveProjector]].
 *
 * A projector object is usually built using one of the static methods from
 * [[netconfig_extensions.projection.ProjectorFactory]]
 *
 * @see [[netconfig_extensions.projection.ProjectorFactory]]
 *
 * @author tjhunter
 */
trait Projector[L <: Link] extends MMLogging {
   ...
   *
   * This set is computed efficiently in [[netconfig_extensions.projection.KDProjector]]
   * and very simply in [[netconfig_extensions.projection.NaiveProjector]].
   */
